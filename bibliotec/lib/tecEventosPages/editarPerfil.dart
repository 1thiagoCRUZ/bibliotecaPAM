import 'dart:io';
import 'package:bibliotec/tecEventosPages/utils/textFormFieldEditUser.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios, color: Colors.black, size: 27,),
          onPressed: () {
              ...
              children: [
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('imagens/retanguloEditPerfil.png'),
                      fit: BoxFit.fill,
                    ),
                ),
                ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: SizedBox(
                            height: 130,
                            width: 130,
                            child: imagePerfil == null ? Image.asset('imagens/fotoPerfil.png')
                            : ClipRRect(
                        ...
                        const Column(
                          children:[
                            Text("Gabriel Felix", style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 22,
                          ),
                            ),
                            Text("Desempregado", style: TextStyle(
                              fontSize: 16,
                        ...
                        const SizedBox(
                         ...
                         TextFFEditUser(
                          ...
                          iconeInicio: Icon(Icons.person_outline, size: 17,),
                        ),
                                ...
                                child: Row(
                                  children: [
                                    Container(
                                      width: 55,
                                      height: 55,
                                      child: Icon(Icons.add_photo_alternate_outlined, size: 25, color: Color(0xff1565C0),),
                                      decoration: BoxDecoration(
                                    ...
                                    SizedBox(width: 32,),
                                    Text("Ir à galeria", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),)
                                  ],
                                ),
                              )
                            ],
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    width: 55,
                                    height: 55,
                                    child: Icon(Icons.add_a_photo_outlined, size: 25, color: Color(0xff1565C0),),
                                    decoration: BoxDecoration(
                                      color: Color(0xffE3F2FD),
                                      shape: BoxShape.circle,
                                    ),
                                  ...
                                  SizedBox(width: 32,),
                                  Text("Tirar uma foto agora", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),)
                                ],
                              ),
                            )
                          ],
